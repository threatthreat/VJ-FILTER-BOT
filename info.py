...
auth_channel = environ.get('AUTH_CHANNEL', '-1002275381683 -1002373968711') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1002275381683 -1002373968711')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/movieaandseries7')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/mww778')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'mazzy70') # Support Chat Link Without https:// or @
